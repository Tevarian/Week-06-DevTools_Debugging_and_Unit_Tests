...
describe("Week 6 War Tests:", () => {
    describe("Check first card of deck", () => {
      it("#Should show that the first card of the deck is the 2 of hearts", () => {
      class Player {
          constructor() {
              // this.nickName = nickname;    // maybe prompt for user to enter player names and then start - might ignore
              this.playerHand = [];
              this.playerScore = 0;
          }
      ...
      expect(newDeck.deck[0]).to.equal({ rank: 2, suit: "♥", value: 2 })
